...
- Name: role-tests\operator.spec.ts >> Operator Role - NEW >> Attendance Management >> Can access attendance page
- Location: tests\e2e\role-tests\operator.spec.ts:92:5
