      ...
      <div className="px-4 space-y-4">
        ...
        <div className="space-y-3">
          {Array.from({ length: items }).map((_, i) => (
            <div key={i} className="bg-white dark:bg-[#1a1d24] rounded-2xl shadow-sm p-4">
      ...
      <div className="px-4 space-y-4">
        ...
        <div className="space-y-2">
          {Array.from({ length: 3 }).map((_, i) => (
            <div key={i} className="bg-white dark:bg-[#1a1d24] rounded-xl p-3 flex items-center gap-3">
