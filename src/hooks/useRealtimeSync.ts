...
const TABLE_QUERY_MAP: Record<string, string[]> = {
  ...
  vehicle_integrations: ["vehicles", "with-integrations"],
  vehicle_telemetry: ["vehicle_telemetry"],
  vehicle_alert_thresholds: ["vehicle_alert_thresholds"],
  vehicle_fleet_summary: ["vehicle_fleet_summary"],
  vehicle_sessions: ["vehicle_sessions"],
  vehicle_session_stops: ["vehicle_session_stops"],
...
const ROLE_TABLE_MAP: Record<string, string[]> = {
  ...
  manager: [
    ...
    "vehicle_integrations", "vehicle_telemetry", "vehicle_alert_thresholds",
    "vehicle_fleet_summary", "vehicle_sessions", "vehicle_session_stops",
  ],
  operator: [
