-- Migration: Guard double-fulfillment and set updated_by on order fulfillment
-- Date: 2026-06-01
-- 
-- Issues fixed:
-- 1. record_sale RPC: Add AND o.status != 'delivered' to prevent re-fulfilling delivered orders
-- 2. record_sale RPC: Set orders.updated_by = p_recorded_by for audit trail completeness
