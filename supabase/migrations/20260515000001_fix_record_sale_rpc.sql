-- Fix record_sale RPC: use p_customer_id for credit limit, fix CROSS JOIN warehouse resolution
...
BEGIN
    ...
    UPDATE public.orders o SET status = 'delivered', delivered_at = now()
