-- ============================================================================
-- Harden record_sale: compute outstanding_amount server-side
-- Previously: v_new_outstanding := v_old_outstanding + p_outstanding_amount
-- Now: compute delta from total - cash - upi (ignore client-supplied value)
-- The p_outstanding_amount parameter is kept for backwards compatibility but
-- is no longer used in balance computation.
-- ============================================================================
