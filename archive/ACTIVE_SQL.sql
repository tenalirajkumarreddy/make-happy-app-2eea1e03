...
-- Display ID counters table (prefix + YYYYMMDD + sequence)
...
-- Generate display ID (Format: PREFIX-YYYYMMDD-0001)
-- `seq_name` is accepted for backwards-compat with clients that still pass it.
