          ...
          <div className="h-14 flex items-center px-4 gap-3">
            ...
            <div className="flex items-center gap-2.5 min-w-0 flex-1">
              {onMenuClick && (
                <button
                  onClick={onMenuClick}
                  className="p-1.5 -ml-1 rounded-lg text-white/80 hover:text-white hover:bg-background/10 transition-all shrink-0"
              ...
              {companyLogo ? (
                ...
                <div className="h-8 w-8 rounded-xl bg-background/10 backdrop-blur-sm flex items-center justify-center shrink-0 ring-1 ring-white/20 overflow-hidden">
                  <img
                    src="/logo.png"
                    alt="Logo"
            ...
            <div className="flex items-center gap-0.5 shrink-0">
              ...
              <button
                onClick={toggle}
                className="p-2 rounded-full text-white/80 hover:text-white hover:bg-background/10 transition-all"
              ...
              {/* Notifications */}
              <button
                className="relative p-2 rounded-full text-white/80 hover:text-white hover:bg-background/10 transition-all min-w-[44px] min-h-[44px] flex items-center justify-center"
              ...
              <DropdownMenu>
                <DropdownMenuTrigger asChild>
                  <button className="flex items-center gap-1 ml-1 p-1 rounded-full hover:bg-background/10 transition-all">
                    <div className="h-7 w-7 rounded-full bg-background/25 ring-2 ring-white/40 flex items-center justify-center">
                ...
                <DropdownMenuContent align="end" className="w-56 mt-1">
                  ...
                  <DropdownMenuItem
                    onClick={() =>
                      navigate(
                        role === "customer" ? "/portal/profile" : "/profile",
                      )
                    }
